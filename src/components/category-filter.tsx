            ...
            return (
              <li key={category}>
                <button
                  ...
                  className={`relative font-display text-[12px] uppercase tracking-[0px] whitespace-nowrap px-[2px] py-[1px] min-h-[44px] flex items-center rounded-[4px] cursor-pointer transition-colors duration-150 ease-out focus-ring active:opacity-70 ${isActive ? "text-foreground" : "text-foreground/70 hover:bg-black/6"}`}
                >
                  <span
