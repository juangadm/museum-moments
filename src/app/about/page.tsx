...
export const metadata: Metadata = {
  title: "About",
  description:
    "Museum Moments captures design moments that stop you mid-scroll. Every entry is hand-selected and described like an exhibit label, built for the age of AI.",
};
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6 font-body text-[13px] leading-[1.6]">
          ...
          <p>
            ...
            The things that inspire and are beautiful, whether generated by AI or shaped by human hands.
          </p>
